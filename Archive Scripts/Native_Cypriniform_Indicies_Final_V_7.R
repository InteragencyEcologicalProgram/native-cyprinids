...
SAPM_Index_Final$Delta_Wide_Index = rowSums(SAPM_Index_Final[,2:4])
...
SPLT_Index_Final$Delta_Wide_Index = rowSums(SPLT_Index_Final[,2:4])
...
SASU_Index_Final$Delta_Wide_Index = rowSums(SASU_Index_Final[,2:4])
